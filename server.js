...
// Require Statements
// -------------------------
const express = require('express'); //middleware, express sets up HTTP file 
const app = express(); //creates variabble app & assign to express
...
// -------------------------
app.use(express.urlencoded({extended:false})); // used to read json files
